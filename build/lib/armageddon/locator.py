    ...
    def get_population_of_postcode(self, postcodes, sector=False):
        ...
        for count, postcode in enumerate(postcodes):
            ...
            if sector:
                ...
                Mod_PC = []
                count = 0
                for pc in Get_population["List_{}".format(count)]:
                    if pc.isspace() == False:
                        pc = pc[:4] + ' ' + pc[-1]
                    ...
                    count += 1
                    Mod_PC.append(pc)
                Get_population["district_{}".format(count)] = Mod_PC

                # Get_population["List_{}".format(count)].str.len() == 5
                # # Format postcodes at different sizes
                # Get_population["district_{}".format(count)] = np.where(
                #     Get_population["List_{}".format(count)].str.len() == 5,
                #     Get_population
                #     ["List_{}".format(count)].str.replace(" ", "  "),
...
# locator = PostcodeLocator()
# res1 = locator.get_postcodes_by_radius((51.4981, -0.1773), [0.13e4])
# res2 = locator.get_postcodes_by_radius((51.4981, -0.1773), [0.13e4], sector = True)
# print(len(res2))
# res3 = locator.get_population_of_postcode(res1)
# res4 = locator.get_population_of_postcode(res2, sector = True)
# print(len(res4))
# print(res1)
# print(res2)
# print(res3)
